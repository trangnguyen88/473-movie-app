...
var SuperBad= new Movie({title: 'Super Bad', photo: './img/4.jpg', meta: {votes : 0, likes : 0}});

var Scott= new Movie({title: 'Scott Pligrim Vs The World', photo: './img/5.jpg', meta: {votes : 0, likes : 0}});
